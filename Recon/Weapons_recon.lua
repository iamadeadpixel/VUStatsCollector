...
-- Print lines will be removed on the end
	...
	if playerscollected[s_Inflictor.name] and args[7] == "JNG-90" then
...
--
	if playerscollected[s_Inflictor.name] and args[7] == "L96" then
...
--
	if playerscollected[s_Inflictor.name] and args[7] == "M39 EMR" then
...
--
	if playerscollected[s_Inflictor.name] and args[7] == "M40A5" then
...
--
	if playerscollected[s_Inflictor.name] and args[7] == "M417" then
...
--
	if playerscollected[s_Inflictor.name] and args[7] == "M98B" then
...
--
	if playerscollected[s_Inflictor.name] and args[7] == "MK11 MOD 0" then
...
--
	if playerscollected[s_Inflictor.name] and args[7] == "QBU-88" then
...
--
	if playerscollected[s_Inflictor.name] and args[7] == "SKS" then
...
--
	if playerscollected[s_Inflictor.name] and args[7] == "SV98" then
...
--
	if playerscollected[s_Inflictor.name] and args[7] == "SVD" then
