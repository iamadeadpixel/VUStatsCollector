...
--			if player.name == getnamehuman[player.name] then
			print ("Updating tbl_playerdata rounds for "..getnamehuman[rounddata])
				if not SQL:Query('UPDATE tbl_playerdata SET Rounds=Rounds+?  WHERE Soldiername = ?', 1, getnamehuman[rounddata]) then
	...
	print ("")
			...
			for data_playername, PDkills in pairs(playerkills) do
				if getnamehuman[player.name] == data_playername then
					...
					if not SQL:Query('UPDATE tbl_playerstats SET Kills=Kills+? WHERE Soldiername = ?', PDkills, getnamehuman[data_playername]) then
						print('Failed to execute Update query: ' .. SQL:Error()) -- If everything works, this would never be printed...
						return
					end
				end
			...
			for data_playername, PDdeaths in pairs(playerdeaths) do
				if getnamehuman[player.name] == data_playername then
					...
					if not SQL:Query('UPDATE tbl_playerstats SET Deaths=Deaths+? WHERE Soldiername = ?', PDdeaths, getnamehuman[data_playername]) then
						print('Failed to execute Update query: ' .. SQL:Error()) -- If everything works, this would never be printed...
						return
					end
				end
			...
			for data_playername, PDsuicide in pairs(playersuicides) do
				if getnamehuman[player.name] == data_playername then
					...
					if not SQL:Query('UPDATE tbl_playerstats SET Suicide=Suicide+? WHERE Soldiername = ?', PDsuicide, getnamehuman[data_playername]) then
						print('Failed to execute Update query: ' .. SQL:Error()) -- If everything works, this would never be printed...
						return
					end
				end
			...
			for data_playername, PDheadshot in pairs(playerheadshot) do
				if getnamehuman[player.name] == data_playername then
					...
					if not SQL:Query('UPDATE tbl_playerstats SET Headshots=Headshots+? WHERE Soldiername = ?', PDheadshot, getnamehuman[data_playername]) then
						print('Failed to execute Update query: ' .. SQL:Error()) -- If everything works, this would never be printed...
						return
					end
				end
			...
			for data_playername, PDteamkilled in pairs(playerteamkilled) do
				if getnamehuman[player.name] == data_playername then
					...
					if not SQL:Query('UPDATE tbl_playerstats SET TeamKilled=TeamKilled+? WHERE Soldiername = ?', PDteamkilled, getnamehuman[data_playername]) then
						print('Failed to execute Update query: ' .. SQL:Error()) -- If everything works, this would never be printed...
						return
					end
				end
			...
			for data_playername, PDdogtags in pairs(playerdogtags) do
				if getnamehuman[player.name] == data_playername then
					...
					if not SQL:Query('UPDATE tbl_playerstats SET Dogtags=Dogtags+? WHERE Soldiername = ?', PDdogtags, getnamehuman[data_playername]) then
						print('Failed to execute Update query: ' .. SQL:Error()) -- If everything works, this would never be printed...
						return
					end
				end
			...
			for data_playername, PDrevives in pairs(playerrevivs) do
				if getnamehuman[player.name] == data_playername then
					...
					if not SQL:Query('UPDATE tbl_playerstats SET Revives=Revives+? WHERE Soldiername = ?', PDrevives, getnamehuman[data_playername]) then
						print('Failed to execute Update query: ' .. SQL:Error()) -- If everything works, this would never be printed...
						return
					end
				end
