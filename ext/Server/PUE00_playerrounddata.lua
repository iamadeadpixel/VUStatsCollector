...
--
--
			for playerdata, tabledata in pairs(Revives_Give) do
				eor_revives = eor_revives + tabledata
			end

			for playerdata, tabledata in pairs(TeamKilled_Killer) do
				eor_teamskills = eor_teamskills + tabledata
			end

			for playerdata, tabledata in pairs(Dogtags_Killer) do
				eor_dogtags = eor_dogtags + tabledata
			end

			for playerdata, tabledata in pairs(Headshots_Killer) do
...
-- --------------------------------------------------
	...
	if Config.consolespam_functioncalls_msg then
	print ("")
	print ("Start function 24")
	print ("*** Start tbl_revives - Dump all revives given data ***")
	print ("")
	end
			-- --------------------------------------------------
			-- --------------------------------------------------
			-- --------------------------------------------------
			--	Collected Revives stuff
			--	tbl_revives
			-- --------------------------------------------------
			-- --------------------------------------------------
			-- --------------------------------------------------
		...
		for data_playername, pname in pairs(getnameall) do
				r_var1data = Revives_Give[data_playername]
				if r_var1data == nil then r_var1data = 0 ; end

				var1data = "Revives_Give"
				s_table = "tbl_revives"

	if Config.consolespam_functioncalls then
				updateweaponstatssolo(player, data_playername)
	end
	end
	...
	if Config.consolespam_functioncalls_msg then
	print ("")
	print ("Start function 25")
	print ("*** Start tbl_revives - Dump all revives taken data ***")
	print ("")
	end

		for data_playername, pname in pairs(getnameall) do
				r_var1data = Revives_Take[data_playername]
				if r_var1data == nil then r_var1data = 0 ; end

				var1data = "Revives_Take"
				s_table = "tbl_revives"
	...
	if Config.consolespam_functioncalls_msg then
	print ("")
	print ("Start function 26")
	print ("*** Start tbl_teamkilled - Dump all teamkill data ***")
	print ("")
	end
			-- --------------------------------------------------
			-- --------------------------------------------------
			-- --------------------------------------------------
			--	Collected teamkill stuff
			--	tbl_teamkilled
			-- --------------------------------------------------
			-- --------------------------------------------------
			-- --------------------------------------------------
		...
		for data_playername, pname in pairs(getnameall) do
				r_var1data = TeamKilled_Killer[data_playername]
				if r_var1data == nil then r_var1data = 0 ; end

				var1data = "TeamKilled_Killer"
	...
	if Config.consolespam_functioncalls_msg then
	print ("")
	print ("Start function 27")
	print ("*** Start tbl_teamkilled - Dump all teamkill data ***")
	print ("")
	end

		for data_playername, pname in pairs(getnameall) do
				r_var1data = TeamKilled_Victim[data_playername]
				if r_var1data == nil then r_var1data = 0 ; end

				var1data = "TeamKilled_Victim"
				s_table = "tbl_teamkilled"
	...
	if Config.consolespam_functioncalls_msg then
	print ("")
	print ("Start function 28")
	print ("*** Start tbl_dogtags - Dump all Dogtag/Knife data ***")
	print ("")
	end
			-- --------------------------------------------------
			-- --------------------------------------------------
			-- --------------------------------------------------
			--	Collected Dogtag stuff
			--	tbl_dogtags
			-- --------------------------------------------------
			-- --------------------------------------------------
			-- --------------------------------------------------
		...
		for data_playername, pname in pairs(getnameall) do
				r_var1data = Dogtags_Killer[data_playername]
				if r_var1data == nil then r_var1data = 0 ; end

				var1data = "Dogtags_Killer"
				s_table = "tbl_dogtags"
	...
	if Config.consolespam_functioncalls_msg then
	print ("")
	print ("Start function 29")
	print ("*** Start tbl_dogtags - Dump all Dogtag/Knife data ***")
	print ("")
	end

		for data_playername, pname in pairs(getnameall) do
				r_var1data = Dogtags_Victim[data_playername]
				if r_var1data == nil then r_var1data = 0 ; end

				var1data = "Dogtags_Victim"
				s_table = "tbl_dogtags"
	...
	if Config.consolespam_functioncalls_msg then
	print ("")
	print ("Start function 30")
	print ("*** Start tbl_headshots - Dump all headshots data ***")
	print ("")
	end
			-- --------------------------------------------------
			-- --------------------------------------------------
		...
		for data_playername, pname in pairs(getnameall) do
				r_var1data = Headshots_Killer[data_playername]
				if r_var1data == nil then r_var1data = 0 ; end

				var1data = "Headshots_Killer"
	...
	if Config.consolespam_functioncalls_msg then
	print ("")
	print ("Start function 31")
	print ("*** Start tbl_headshots - Dump all headshots data ***")
	print ("")
	end

		for data_playername, pname in pairs(getnameall) do
				r_var1data = Headshots_Victim[data_playername]
				if r_var1data == nil then r_var1data = 0 ; end

				var1data = "Headshots_Victim"
				s_table = "tbl_headshots"
