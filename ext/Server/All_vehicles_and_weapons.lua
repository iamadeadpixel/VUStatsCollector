...
-- Here we collect the base stats for tbl_playerstats
	...
	print ("### Roadkill data for "..args[4].." Roadkills:"..roadkills[s_Inflictor.name].." ###")
		end
		end
		--
	...
	print ("### Suicide data for "..args[1].." Suicide:"..playersuicides[p_Player.name].." ###")
	print ("### Death data for "..args[1].." Deaths:"..playerdeaths[p_Player.name].." ###")
		end
		--
	...
	print ("### Kill data for "..args[4].." Kills:"..playerkills[s_Inflictor.name].." ###")
		end
		--
	...
	print ("### Headshot data for "..args[4].." Headshots:"..playerheadshot[s_Inflictor.name].." ###")
		end
		--
	...
	print ("### KnifeKill data for "..args[4].." KnifeKills:"..playerdogtags[s_Inflictor.name].." ###")
		end
		--
	...
	print ("### TeamKill data for "..args[4].." TeamkKills:"..playerteamkilled[s_Inflictor.name].." ###")
		end
