...
--		print("** Player results:" ..getnamehuman[pname] .. " - Knife kills:" .. chat_Dogtags .. " - Revives:" ..chat_Revives .. " - Roadkills:" .. chat_roadkills)
		...
		print("** Player results:" ..pname .. " - Score:" .. chat_Score .. " - Kills:" .. chat_Kills .. " - Deaths:" .. chat_Deaths)
		print("** Player results:" ..pname .. " - Suicides:" .. chat_Suicide .." - Headshots:" .. chat_Headshots .. " - Teamkilled:" .. chat_TeamKilled)
		print("** Player results:" ..pname .. " - Knife kills:" .. chat_Dogtags .. " - Revives:" ..chat_Revives .. " - Roadkills:" .. chat_roadkills)
