...
--[[
	...
	if Death_MAV[p_Player.name] == nil then Death_MAV[p_Player.name] = 0 ; end  -- Victim
	Death_MAV[p_Player.name] = Death_MAV[p_Player.name] + 1  -- Victim

	if p_IsHeadShot then 
	if Headshot_MAV[p_Player.name] == nil then Headshot_MAV[p_Player.name] = 0 ; end  -- Victim
...
--
	...
	if Death_RADIO_BEACON[p_Player.name] == nil then Death_RADIO_BEACON[p_Player.name] = 0 ; end  -- Victim
	Death_RADIO_BEACON[p_Player.name] = Death_RADIO_BEACON[p_Player.name] + 1  -- Victim

	if p_IsHeadShot then 
	if Headshot_RADIO_BEACON[p_Player.name] == nil then Headshot_RADIO_BEACON[p_Player.name] = 0 ; end  -- Victim
...
--
	...
	if Death_SOFLAM[p_Player.name] == nil then Death_SOFLAM[p_Player.name] = 0 ; end  -- Victim
	Death_SOFLAM[p_Player.name] = Death_SOFLAM[p_Player.name] + 1  -- Victim

	if p_IsHeadShot then 
	if Headshot_SOFLAM[p_Player.name] == nil then Headshot_SOFLAM[p_Player.name] = 0 ; end  -- Victim
...
--
	...
	if Death_T_UGS[p_Player.name] == nil then Death_T_UGS[p_Player.name] = 0 ; end  -- Victim
	Death_T_UGS[p_Player.name] = Death_T_UGS[p_Player.name] + 1  -- Victim

	if p_IsHeadShot then 
	if Headshot_T_UGS[p_Player.name] == nil then Headshot_T_UGS[p_Player.name] = 0 ; end  -- Victim
...
print("No data found for "..data_playername.." and "..data_weapon_name.." - Injecting now")
	...
	if Config.consolespam_recon_gadgets5 then
