...
-- Here we collect the base stats for tbl_playerstats
	...
	if Config.consolespam_base then
		print("==== suicide stats for :"..p_Player.name.." - Suicides:"..playersuicides[p_Player.name].." - Deaths:"..playerdeaths[p_Player.name])
	end
		end
		--
	...
	if Config.consolespam_base then
		print("==== Kill stats for :"..s_Inflictor.name.." - Kills:"..playerkills[s_Inflictor.name])
	end
		end
		--
	...
	if Config.consolespam_base then
		print("==== Death stats for :"..p_Player.name.." - Deaths:"..playerdeaths[p_Player.name])
	end
		end
		--
	...
	if Config.consolespam_base then
		print("==== Teamkill stats for :"..s_Inflictor.name.." - Teamkills:"..playerteamkilled[s_Inflictor.name])
	end
		end
