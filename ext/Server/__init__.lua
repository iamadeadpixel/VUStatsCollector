...
--	self.m_Timertest = require('Timertest') -- Timer test stuff, should be disabled under normal conditions.
...
Here set all kill data per class
	...
	self.m_Collect_assault_data = require('Collect_assault_data')
	self.m_Collect_engineer_data = require('Collect_engineer_data')
	self.m_Collect_support_data = require('Collect_support_data')
	self.m_Collect_recon_data = require('Collect_recon_data')
end
