...
--[[
	** Experimental **
	...
	at this point, only humans are logged, the bot stuff was removed due some, eh, isues.....
	dont set if it false in the config.lua, only the first bot kill is logged.
