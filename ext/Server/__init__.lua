...
Here set all kill data per class
	...
	self.m_Collect_dogtags_data = require('Collect_dogtags_data')
	self.m_Collect_headshot_data = require('Collect_headshot_data')
	self.m_Collect_revives_data = require('Collect_revives_data')
	self.m_Collect_teamkilled_data = require('Collect_teamkilled_data')
