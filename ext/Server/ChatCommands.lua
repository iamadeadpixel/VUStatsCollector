...
--
		if Dogtags_Killer[player.name] == nil then Dogtags_Killer[player.name] = 0; end
		if Headshots_Killer[player.name] == nil then Headshots_Killer[player.name] = 0; end
		...
		chat_Dogtags = Dogtags_Killer[player.name]
		chat_Headshots = Headshots_Killer[player.name]
		chat_Revives = Revives_Give[player.name]
		chat_TeamKilled = TeamKilled_Killer[player.name]
