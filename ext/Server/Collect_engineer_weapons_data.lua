...
--[[
	...
	if Headshot_A_91[p_Player.name] == nil then Headshot_A_91[p_Player.name] = 0 ; end
...
--
	...
	if p_IsHeadShot then 
	if Headshot_ACW_R[p_Player.name] == nil then Headshot_ACW_R[p_Player.name] = 0 ; end
...
--
	...
	if p_IsHeadShot then 
	if Headshot_AKS_74u[p_Player.name] == nil then Headshot_AKS_74u[p_Player.name] = 0 ; end
...
--
	...
	if p_IsHeadShot then 
	if Headshot_G36C[p_Player.name] == nil then Headshot_G36C[p_Player.name] = 0 ; end
...
--
	...
	if p_IsHeadShot then 
	if Headshot_G53[p_Player.name] == nil then Headshot_G53[p_Player.name] = 0 ; end
...
--
	...
	if p_IsHeadShot then 
	if Headshot_M4[p_Player.name] == nil then Headshot_M4[p_Player.name] = 0 ; end
...
--
	...
	if p_IsHeadShot then 
	if Headshot_M4A1[p_Player.name] == nil then Headshot_M4A1[p_Player.name] = 0 ; end
...
--
	...
	if p_IsHeadShot then 
	if Headshot_MTAR_21[p_Player.name] == nil then Headshot_MTAR_21[p_Player.name] = 0 ; end
...
--
	...
	if p_IsHeadShot then 
	if Headshot_QBZ_95B[p_Player.name] == nil then Headshot_QBZ_95B[p_Player.name] = 0 ; end
...
--
	...
	if p_IsHeadShot then 
	if Headshot_SCAR_H[p_Player.name] == nil then Headshot_SCAR_H[p_Player.name] = 0 ; end
...
--
	...
	if p_IsHeadShot then 
	if Headshot_SG553[p_Player.name] == nil then Headshot_SG553[p_Player.name] = 0 ; end
...
print("No data found for "..data_playername.." and "..data_weapon_name.." - Injecting now")
	...
	if Config.consolespam_engineer_weapons5 then
