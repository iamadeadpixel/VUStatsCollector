...
print ("Human player count:"..CountPlayers)
	...
	if Session_PlayTime_End[player.name] then   print("*** Player playtime on logout in seconds : " ..Session_PlayTime_End[player.name] ) ; end
...
-- only one should be active, or non, this is onfo only
