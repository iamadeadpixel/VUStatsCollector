...
-- Print lines will be removed on the end
	...
	if args[7] == "AMMO BOX" then
		...
		if death_AMMO_BOX[p_Player.name] == nil then death_AMMO_BOX[p_Player.name] = 0; end
