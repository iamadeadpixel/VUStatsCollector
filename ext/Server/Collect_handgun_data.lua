...
--[[
	...
	if Headshot_MP443[p_Player.name] == nil then Headshot_MP443[p_Player.name] = 0 ; end
...
--
	...
	if p_IsHeadShot then 
	if Headshot_MP412_REX[p_Player.name] == nil then Headshot_MP412_REX[p_Player.name] = 0 ; end
...
--
	...
	if p_IsHeadShot then 
	if Headshot_M9[p_Player.name] == nil then Headshot_M9[p_Player.name] = 0 ; end
...
--
	...
	if p_IsHeadShot then 
	if Headshot_M1911[p_Player.name] == nil then Headshot_M1911[p_Player.name] = 0 ; end
...
--
	...
	if p_IsHeadShot then 
	if Headshot_G18[p_Player.name] == nil then Headshot_G18[p_Player.name] = 0 ; end
...
--
	...
	if p_IsHeadShot then 
	if Headshot_G17C[p_Player.name] == nil then Headshot_G17C[p_Player.name] = 0 ; end
...
--
	...
	if p_IsHeadShot then 
	if Headshot_93R[p_Player.name] == nil then Headshot_93R[p_Player.name] = 0 ; end
...
--
	...
	if p_IsHeadShot then 
	if Headshot_44_MAGNUM[p_Player.name] == nil then Headshot_44_MAGNUM[p_Player.name] = 0 ; end
...
print("No data found for "..data_playername.." and "..data_weapon_name.." - Injecting now")
	...
	if Config.consolespam_handguns5 then
