...
-- Print lines will be removed on the end
	...
	death_AEK_971[p_Player.name] = death_AEK_971[p_Player.name] + 1
		end
        end
--
	...
	death_AK_74M[p_Player.name] = death_AK_74M[p_Player.name] + 1
		end
        end
--
	...
	death_AN_94[p_Player.name] = death_AN_94[p_Player.name] + 1
		end
        end
--
	...
	death_AUG_A3[p_Player.name] = death_AUG_A3[p_Player.name] + 1
		end
        end
--
	...
	death_F2000[p_Player.name] = death_F2000[p_Player.name] + 1
		end
        end
--
	...
	death_FAMAS[p_Player.name] = death_FAMAS[p_Player.name] + 1
		end
        end
--
	if args[7] == "G3A3" then
	...
	death_G3A3[p_Player.name] = death_G3A3[p_Player.name] + 1
		end
        end
--
	...
	death_KH2002[p_Player.name] = death_KH2002[p_Player.name] + 1
		end
        end
--
	...
	death_L85A2[p_Player.name] = death_L85A2[p_Player.name] + 1
		end
        end
--
	...
	death_M16A3[p_Player.name] = death_M16A3[p_Player.name] + 1
		end
        end
--
	...
	death_M16A4[p_Player.name] = death_M16A4[p_Player.name] + 1
		end
        end
--
	if args[7] == "M416" then
	...
	death_M416[p_Player.name] = death_M416[p_Player.name] + 1
		end
        end
--
	...
	death_SCAR_L[p_Player.name] = death_SCAR_L[p_Player.name] + 1
		end
        end
--
