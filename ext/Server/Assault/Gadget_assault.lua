...
-- Print lines will be removed on the end
	...
	death_M320_SMOKE[p_Player.name] = death_M320_SMOKE[p_Player.name] + 1
		end
        end
--
	...
	death_M320_LVG[p_Player.name] = death_M320_LVG[p_Player.name] + 1
		end
        end
--
	...
	death_M320_HE[p_Player.name] = death_M320_HE[p_Player.name] + 1
		end
        end
--
	...
	death_M320_BUCK[p_Player.name] = death_M320_BUCK[p_Player.name] + 1
		end
        end
--
	...
	death_M26_SLUG[p_Player.name] = death_M26_SLUG[p_Player.name] + 1
		end
        end
--
	...
	death_M26_MASS[p_Player.name] = death_M26_MASS[p_Player.name] + 1
		end
        end
--
	...
	death_M26_FRAG[p_Player.name] = death_M26_FRAG[p_Player.name] + 1
		end
        end
--
	...
	death_M26_DART[p_Player.name] = death_M26_DART[p_Player.name] + 1
		end
        end
--
	...
	death_GP_30_SMOKE[p_Player.name] = death_GP_30_SMOKE[p_Player.name] + 1
		end
        end
--
	...
	death_GP_30_LVG[p_Player.name] = death_GP_30_LVG[p_Player.name] + 1
		end
        end
--
	...
	death_GP_30_HE[p_Player.name] = death_GP_30_HE[p_Player.name] + 1
		end
        end
--
	...
	death_GP_30_DART[p_Player.name] = death_GP_30_DART[p_Player.name] + 1
		end
        end
--
	...
	death_GP_30_BUCK[p_Player.name] = death_GP_30_BUCK[p_Player.name] + 1
		end
        end
--
	...
	death_MEDIC_KIT[p_Player.name] = death_MEDIC_KIT[p_Player.name] + 1
		end
        end
--
	...
	death_DEFIBRILLATOR[p_Player.name] = death_DEFIBRILLATOR[p_Player.name] + 1
		end
        end
--
