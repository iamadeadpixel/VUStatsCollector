...
-- Print lines will be removed on the end
	...
	if getnamehuman[s_Inflictor.name] and args[7] == "TV MISSILE" then
...
--
	if getnamehuman[s_Inflictor.name] and args[7] == "A-10 THUNDERBOLT" then
...
--
	if getnamehuman[s_Inflictor.name] and args[7] == "AH-1Z VIPER" then
...
--
	if getnamehuman[s_Inflictor.name] and args[7] == "AH-6J LITTLE BIRD" then
...
--
	if getnamehuman[s_Inflictor.name] and args[7] == "F-35" then
...
--
	if getnamehuman[s_Inflictor.name] and args[7] == "F/A-18E SUPER HORNET" then
...
--
	if getnamehuman[s_Inflictor.name] and args[7] == "GUNSHIP" then
...
--
	if getnamehuman[s_Inflictor.name] and args[7] == "KA-60 KASATKA" then
...
--
	if getnamehuman[s_Inflictor.name] and args[7] == "MI-28 HAVOC" then
...
--
	if getnamehuman[s_Inflictor.name] and args[7] == "SU-25TM FROGFOOT" then
...
--
	if getnamehuman[s_Inflictor.name] and args[7] == "SU-35BM FLANKER-E" then
...
--
	if getnamehuman[s_Inflictor.name] and args[7] == "SU-37" then
...
--
	if getnamehuman[s_Inflictor.name] and args[7] == "UH-1Y VENOM" then
...
--
	if getnamehuman[s_Inflictor.name] and args[7] == "Z-11W" then
