...
-- ------------------------------------------------------
	...
	if Mcom_Armed[player.name] == nil then Mcom_Armed[player.name] = 0 ; end 
...
-- ------------------------------------------------------
	...
	if Mcom_Disarmed[player.name] == nil then Mcom_Disarmed[player.name] = 0 ; end
...
-- ------------------------------------------------------
	...
	if Mcom_Destroyed[player.name] == nil then Mcom_Destroyed[player.name] = 0 ; end
...
function data_Mcom(data_playername)
	...
	if Config.consolespam_mcomevent then
	print ("")
	print (data_catagory.."  event name:"..data_mcom_event)
...
--		print('M-com Stats for "'..data_mcom_event)
	...
	if Config.consolespam_mcomevent then
		print ("M-com Disarmed this round: "..Mcom_Disarmed[data_playername])
		print ("Total M-com data this round: Armed:"..Mcom_Armed[data_playername].." Disarmed:"..Mcom_Disarmed[data_playername].." Destroyed:"..Mcom_Destroyed[data_playername])
	end

	elseif data_mcom_event == "Destroyed" then 
	if Config.consolespam_mcomevent then
		print ("M-com Destroyed this round: "..Mcom_Destroyed[data_playername])
		print ("Total M-com data this round: Armed:"..Mcom_Armed[data_playername].." Disarmed:"..Mcom_Disarmed[data_playername].." Destroyed:"..Mcom_Destroyed[data_playername])
	end
	end
end
